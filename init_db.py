...
async def import_templates():
    ...
    template_descriptions = {
        "group_list_template.docx": "Шаблон списка группы",
        ...
        "Отчет по пратике 6 семестр.docx": "Шаблон отчета по практике за 6 семестр",
        "Отчет по пратике 7 семестр.docx": "Шаблон отчета по практике за 7 семестр",
        ...
        "Титульный лист Лабороторная работа.docx": "Шаблон титульного листа для лабораторной работы",
